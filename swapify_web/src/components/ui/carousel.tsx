...
export const Control = withContext<
  Assign<JsxStyleProps, Carousel.ControlProps>
...
export const Item = withContext<Assign<JsxStyleProps, Carousel.ItemProps>>(
  Carousel.Item,
  "item",
);
...
export const Viewport = withContext<
  Assign<JsxStyleProps, Carousel.ViewportProps>

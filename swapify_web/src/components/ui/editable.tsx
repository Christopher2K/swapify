...
export const Area = withContext<Assign<JsxStyleProps, Editable.AreaProps>>(
  Editable.Area,
  "area",
);
...
export const Control = withContext<
  Assign<JsxStyleProps, Editable.ControlProps>
...
export const Preview = withContext<
  Assign<JsxStyleProps, Editable.PreviewProps>

...
export interface RootProps
  extends Assign<JsxStyleProps, Popover.RootProps>,
    PopoverVariantProps {}
...
export const Arrow = withContext<Assign<JsxStyleProps, Popover.ArrowProps>>(
  Popover.Arrow,
  "arrow",
);
...
export const Title = withContext<Assign<JsxStyleProps, Popover.TitleProps>>(
  Popover.Title,
  "title",
);

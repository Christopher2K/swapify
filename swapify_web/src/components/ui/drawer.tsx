...
export const Backdrop = withContext<
  Assign<JsxStyleProps, Drawer.BackdropProps>
>(Drawer.Backdrop, "backdrop");

export const Body = withContext<Assign<JsxStyleProps, HTMLArkProps<"div">>>(
  ark.div,
  "body",
);
...
export const Footer = withContext<Assign<JsxStyleProps, HTMLArkProps<"div">>>(
  ark.div,
  "footer",
);

export const Header = withContext<Assign<JsxStyleProps, HTMLArkProps<"div">>>(
  ark.div,
  "header",
);
...
export const Title = withContext<Assign<JsxStyleProps, Drawer.TitleProps>>(
  Drawer.Title,
  "title",
);

defmodule SwapifyApiWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: SwapifyApiWeb.Layouts]
  ...
  defp html_helpers do
    quote do
      ...
      import SwapifyApiWeb.Forms
      import SwapifyApiWeb.UI
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: SwapifyApiWeb.Router,
        statics: SwapifyApiWeb.static_paths()
    end
  end
